FROM alpine:3.12
LABEL Maintainer="Ary Wibowo <nucreativa@gmail.com>" \
      Description="Lightweight container with Nginx & PHP-FPM based on Alpine Linux."

# Install packages and remove default server definition
RUN apk --no-cache add php7 php7-fpm php7-opcache php7-mysqli php7-json \
	php7-openssl php7-curl php7-zlib php7-xml php7-phar php7-intl php7-dom \
	php7-xmlreader php7-ctype php7-session php7-tokenizer php7-mbstring \
    php7-gd nginx supervisor curl beanstalkd && \
